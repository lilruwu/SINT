...
<body>
    <h1>Error Files</h1>
    <%
    ArrayList<String> errorsFile = (ArrayList<String>)request.getAttribute("errors");
    ...
    <%
    ArrayList<String> fatalerrorsFile = (ArrayList<String>)request.getAttribute("fatalerrors");
